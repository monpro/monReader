...
<script type="text/ecmascript-6">
  ...
  import { pxToRem, getCurPx } from '../../utils/utils'
  ...
  export default {
    ...
    methods: {
      ...
      itemStyle(item) {
        return {
          marginLeft: (item.deep - 1) * pxToRem(20) + 'rem'
        }
      },
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .book-detail {
    ...
    .content-wrapper {
      ...
      .book-detail-content-wrapper {
        ...
        .book-detail-content-title {
          ...
          font-weight: bold;
          padding: pxToRem(20) pxToRem(15) pxToRem(10) pxToRem(15);
          box-sizing: border-box;
        }
    ...
    .bottom-wrapper {
      ...
      width: 100%;
      height: pxToRem(52);
      box-shadow: 0 pxToRem(-2) pxToRem(2) rgba(0, 0, 0, .1);
      .bottom-btn {
        flex: 1;
        color: $color-blue;
        font-weight: bold;
